...
public:
    ...
    Matrix(int r, int c, bool zeroed, std::string namex="");
    ...
    // Left and right children for kd tree
    // Matrix * left = NULL;
    // Matrix * right = NULL;
...
public:
    ...
    Matrix pickRows(double match, const Matrix &list, int &num);      // pick rows which have list value == match
