...
Matrix::Matrix(int r, int c, bool zeroed, std::string namex)
{
    allocate(r, c, namex);
    for (int r=0; r<maxr; r++) {
        for (int c=0; c<maxc; c++) {
...
// WARNING: allocates new matrix for answer
Matrix Matrix::pickRows(double match, const Matrix &list, int &num)
{
